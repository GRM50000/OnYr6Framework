...
function includepopup() {
   let html1 =
      '<div id="popup"><span id="close-button" onclick="closepopup()">&times;</span><span id="left-button">&#10094;</span><span id="right-button">&#10095;</span><img src="https://placehold.co/400x400/orange/black" alt="mainpopupimage" id="mainpopimage"/></div>';
...
volumeInput.addEventListener("input", function() {audioPlayer.volume = volumeInput.value;
});
